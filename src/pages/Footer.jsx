      ...
      <footer className="bg-powerlightgray text-powerdarkgray ">
        ...
        <div className="flex flex-wrap font-semibold text-sm justify-start mx-1 sm:mx-36 p-4">
          <p className="leading-5">
            Serviço disponível nas áreas de entrega Domino´s Pizza, todos os
            dias, de acordo com o horário de funcionamento de cada loja. A
            Domino´s Pizza Brasil se reserva no direito de alterar ou encerrar
            as ofertas sem aviso prévio. Todas as promoções expostas não são
          ...
          <br />
          <p className="leading-5">
            *Preços "a partir de" podem sofrer pequenas variações de acordo com
            a região da loja. Confirme o preço no carrinho de compras antes de
            confirmar seu pedido.
          </p>
          <br />
          <p>
            DOMINO´S PIZZA BRASIL, Av. das Américas, 500 - Bloco 7 – 3º andar –
